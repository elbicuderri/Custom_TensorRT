...
ConvPluginV2::~ConvPluginV2() override
{
}

int ConvPluginV2::getNbOutputs() const override { return 1; }

int ConvPluginV2::initialize() override { return 0; }

void ConvPluginV2::terminate() override {}
...
size_t ConvPluginV2::getWorkspaceSize(int maxBatchSize) const override { return 0; }
    ...
    void** outputs, void* workspace, cudaStream_t stream) override
{
    ...
    conv_plugin((float*)outputs[0], (float*)inputs[0],
...
size_t ConvPluginV2::getSerializationSize() const override
{
    // iC, iH, iW, oC, oH, oW
    return 6 * sizeof(int);
}

void ConvPluginV2::serialize(void* buffer) const override
{
...
bool ConvPluginV2::supportsFormat(DataType type, PluginFormat format) const override
{
    return ((type == DataType::kFLOAT || type == DataType::kHALF)
        && format == PluginFormat::kNCHW);
}

const char* ConvPluginV2::getPluginType() const override
{
    return "ConvPluginV2";
}

const char* ConvPluginV2::getPluginVersion() const override
{
    return "2";
}

void ConvPluginV2::destroy() override
{
    delete this;
}

IPluginV2Ext* ConvPluginV2::clone() const override
{
...
void ConvPluginV2::setPluginNamespace(const char* pluginNamespace) override
{
    mPluginNamespace = pluginNamespace;
}

const char* ConvPluginV2::getPluginNamespace() const override
{
...
bool ConvPluginV2::canBroadcastInputAcrossBatch(int inputIndex) const override
{
    return false;
}